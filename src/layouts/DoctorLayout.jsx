...
const navItems = [
  { label: 'Dashboard', icon: MdDashboard, to: '/doctor/dashboard' },
  { label: 'Appointments', icon: MdCalendarMonth, to: '/doctor/appointments' },
  { label: 'My Profile', icon: MdPerson, to: '/doctor/profile' },
]
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="mx-3 mb-4 mt-3 p-3 rounded-xl bg-white/[0.05] flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-gray-500 text-xs mt-0.5">Doctor</p>
        </div>
        <button
