  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full pb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-3 max-w-2xl">
            {news?.title}
          </h1>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto flex gap-10">
          ...
          <div className="flex-1">
            {/* featured image */}
            {news?.image && (
              <div className="h-72 bg-gray-200 rounded overflow-hidden mb-8">
                <img
                  src={news.image}
                  alt={news.title}
            ...
            <div className="flex items-center justify-between mt-12 pt-8 border-t border-gray-100">
              {prevNews ? (
                <Link
                  ...
                  className="flex items-center gap-2 border border-navy text-navy px-5 py-2 rounded-full text-sm hover:bg-navy hover:text-white transition"
                >
